...
namespace Service.Boundary.HackneyApi.Person
{
    ...
    {
        private string _baseUrl = "https://virtserver.swaggerhub.com/Hackney/personAPI/1.0.0";
        ...
        /// <returns>Person has been created Successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PersonData> PersonsPOSTAsync(string x_correlation_id, CreatepersonData createPerson)
        {
            return PersonsPOSTAsync(x_correlation_id, createPerson, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Person has been created Successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PersonData> PersonsPOSTAsync(string x_correlation_id, CreatepersonData createPerson, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PersonData>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Successfully retrieved details for a particular person</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<PersonData> PersonsGETAsync(string id, string x_correlation_id)
        {
            return PersonsGETAsync(id, x_correlation_id, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Successfully retrieved details for a particular person</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PersonData> PersonsGETAsync(string id, string x_correlation_id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Person not found for ID requested", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
        ...
        /// <param name="if_Match">This value should be set to the ETag returned as a response header when retrieving a record</param>
        /// <returns>Person details successfully updated</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task PersonsPATCHAsync(string id, string if_Match, string x_correlation_id, UpdatepersonData updatePersonDetail)
        {
            return PersonsPATCHAsync(id, if_Match, x_correlation_id, updatePersonDetail, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Person details successfully updated</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task PersonsPATCHAsync(string id, string if_Match, string x_correlation_id, UpdatepersonData updatePersonDetail, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (x_correlation_id != null)
                        request_.Headers.TryAddWithoutValidation("x-correlation-id", ConvertToString(x_correlation_id, System.Globalization.CultureInfo.InvariantCulture));
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(updatePersonDetail, _settings.Value));
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("ID not found", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
    ...
    public partial class PersonData
    {
        ...
        public PersonDataTitle? Title { get; set; }

        [Newtonsoft.Json.JsonProperty("preferredTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public PersonDataPreferredTitle? PreferredTitle { get; set; }
        ...
        public System.Collections.Generic.ICollection<Tenure> Tenures { get; set; }

        [Newtonsoft.Json.JsonProperty("reason", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Reason { get; set; }

        [Newtonsoft.Json.JsonProperty("links", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<ApiLink> Links { get; set; }

        [Newtonsoft.Json.JsonProperty("isAMinor", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class CreatepersonData
    {
        [Newtonsoft.Json.JsonProperty("title", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CreatepersonDataTitle? Title { get; set; }

        [Newtonsoft.Json.JsonProperty("preferredTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public CreatepersonDataPreferredTitle? PreferredTitle { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("tenures", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<PostTenure> Tenures { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class UpdatepersonData
    {
        [Newtonsoft.Json.JsonProperty("title", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public UpdatepersonDataTitle? Title { get; set; }

        [Newtonsoft.Json.JsonProperty("preferredTitle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public UpdatepersonDataPreferredTitle? PreferredTitle { get; set; }
    ...
    public partial class Tenure
    {
        ...
        public System.Guid? PropertyReference { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class PostTenure
    {
        [Newtonsoft.Json.JsonProperty("id", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Guid? Id { get; set; }
    ...
    public partial class ApiLink
    {
        ...
        [Newtonsoft.Json.JsonProperty("endpointType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string EndpointType { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum PersonDataTitle
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum PersonDataPreferredTitle
    {
    ...
    public enum PersonTypes
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"Leaseholder")]
        Leaseholder = 2,

        [System.Runtime.Serialization.EnumMember(Value = @"Freeholder")]
        Freeholder = 3,

        [System.Runtime.Serialization.EnumMember(Value = @"Occupant")]
        Occupant = 4,

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum CreatepersonDataTitle
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum CreatepersonDataPreferredTitle
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum UpdatepersonDataTitle
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.9.0 (NJsonSchema v10.6.8.0 (Newtonsoft.Json v11.0.0.0))")]
    public enum UpdatepersonDataPreferredTitle
    {
